def main():
    ...
    while True:  # main gameplay loop
        ...
        if len(inventory) == 6:
            print(
                'Congratulations! You have aquired all the items, you are now the GOAT!')
            break  # player wins
        ...
        if title == 'East' or title == 'West' or title == 'North' or title == 'South':
            ...
            if new_location == 'Castle':  # if
                print(
                    'YEET! GAME OVER! You have reached Lord Uub without all the items!')
                break  # player loses
            ...
            if item in inventory:
                # input validation
                print('You have already retrieved this item!')
            else:
